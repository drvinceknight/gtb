...
\definecolor{blue}{RGB}{91,144,198}
\definecolor{orange}{RGB}{235,191,51}
\definecolor{green}{RGB}{147,91,57}
...
\begin{tikzpicture}
  ...
  \foreach \i in {1,...,\nsteps} {
    ...
    % Step size label
    \draw[green, <->] (\t,\x) -- (\tnext,\x) node[midway, fill=gtbpaper, inner sep=1pt] {\scriptsize $h$};
