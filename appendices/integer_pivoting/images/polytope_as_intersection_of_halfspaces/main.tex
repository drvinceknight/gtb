...
\begin{tikzpicture}[scale=12]
  ...
  % 1. shade left side 
  \fill[pattern=north east lines, pattern color=gtbcoral!70]
    (-0.2, -0.1) rectangle (0, 0.5);

  % 2.  shade right side 
  \fill[pattern=north west lines, pattern color=gtbsage!70]
    (0.3667, -0.1) -- 
    (.1667, 0.5) --
    (.7, .5) --
    (.7, -.1) -- cycle;
  ...
  % 3. shade above
  \fill[pattern=horizontal lines, pattern color=gtbyellow!80]
    (-.2, .4) --
    (-.2, .5) --
    (0.7, 0.5) --
    (0.7, .1) -- cycle;
  ...
  \fill[pattern=vertical lines, pattern color=gtbviolet!60]
    (-0.2, -0.1) rectangle (0.7, 0);

  % Draw polxytope
  \filldraw[fill=gtbpaper, draw=gtbblue, thick]
