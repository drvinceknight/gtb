...
\begin{tikzpicture}
    ...
    % Draw a blue square
    \draw[draw=gtbblue, very thick] (2,0) rectangle (1,1);

    % Draw a blue triangle
    \draw[draw=gtbblue, very thick] (2.5,2) -- (3.5,2) -- (3,3) -- cycle;

    % Draw a blue circle
    \draw[draw=gtbblue, very thick] (0,2) circle (0.5);

    % Arrows from the square to the circle (slightly offset)
    \draw[->, thick, gtbcoral] (1.2,1.1) to[out=100, in=25] (.6,1.8); 
    ...
    \draw[->, thick, gtbcoral] (3,3.1) to[out=45, in=135] (4.2,4.2);
