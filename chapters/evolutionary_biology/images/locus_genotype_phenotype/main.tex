...
\definecolor{alleleA}{HTML}{0072B2}
\definecolor{allelea}{HTML}{D55E00}
\definecolor{phen}{HTML}{009E73}
...
\node[lab, anchor=north, text=black!70] at (0,4.78)
...
\node[geno, draw=black!55]               (Aa) at (0,2.7)  {Aa};
\node[geno, draw=allelea, text=allelea] (aa) at (3,2.7)  {aa};
